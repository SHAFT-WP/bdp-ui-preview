import { installResultPanel } from "./common/ui/result-panel-v0.1.mjs?v=238773dd7ba1";
import { installSvgLegend } from "./common/diagram/svg-legend-v0.1.mjs?v=238773dd7ba1";
import {
  ...
  svgNode,
  trimPolylineAtNodes,
} from "./common/diagram/svg-primitives-v0.1.mjs?v=238773dd7ba1";
import {
  SVG_PNG_EXPORT_V0_1,
  saveSvgAsPng,
} from "./common/diagram/svg-png-export-v0.1.mjs?v=238773dd7ba1";
...
await import("./bdp-graph-renderers.js?v=238773dd7ba1");
await import("./bdp-top-view-visibility.js?v=238773dd7ba1");
await import("./bdp-ui-adapter.js?v=238773dd7ba1");
await import("./bdp-v2-core.js?v=238773dd7ba1");
await import("./bdp-v2-provider.js?v=238773dd7ba1");
